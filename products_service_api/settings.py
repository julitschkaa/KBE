"""
Django settings for products_service_api project.
...
SECRET_KEY = 'django-insecure-q*t!odg6#%zn$@+$^rk1%ak1_kivf%7pvrs)s#3lqdp&&qre$-'
...
WSGI_APPLICATION = 'products_service_api.wsgi.application'
